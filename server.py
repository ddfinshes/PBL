...
async def api_generate_intervention_suggestions(request: InterventionStrategyRequest):
    ...
    try:
        ...
        types = [
            ...
            {"type": "Answer", "desc": "扮演病人回答，需要提示LLM生成的策略包含“我现在要扮演病人请你回答我”"},
